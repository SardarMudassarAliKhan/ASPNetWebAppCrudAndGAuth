...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2 class="mb-4 text-center">Product Management (CRUD + Search + Filter)</h2>

    <!-- Search + Filter -->
    <div class="row mb-4">
      <div class="col-md-4">
        <asp:TextBox ID="txtSearch" runat="server" CssClass="form-control" placeholder="Search by product name..." />
      </div>
      <div class="col-md-2">
    ...
    <!-- Add -->
    <div class="mb-3">
      <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#productModal">Add New Product</button>
    </div>
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Actions">
            <ItemTemplate>
                <asp:Button CssClass="btn btn-sm btn-warning me-2" Text="Edit" data-bs-toggle="modal" data-bs-target="#productModal"
